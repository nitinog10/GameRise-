...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-dark relative overflow-hidden flex items-center justify-center px-4">
      {/* Background */}
      <div className="orb w-[400px] h-[400px] bg-accent-purple/[0.06] top-[10%] left-[10%]" />
      <div className="orb w-[300px] h-[300px] bg-neon/[0.04] bottom-[15%] right-[10%]" style={{ animationDelay: '-8s' }} />
      ...
      <div className="relative z-10 w-full max-w-sm animate-scale-in">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">Sign in to continue your esports journey</p>
        </div>
        ...
        <p className="text-center text-gray-500 text-sm mt-5">
          ...
          <Link to="/register" className="text-neon font-medium hover:underline">Join GameRise</Link>
        </p>

        <div className="mt-6 flex items-center justify-center gap-5 text-[10px] text-gray-600">
          <span className="flex items-center gap-1.5"><span className="w-1 h-1 rounded-full bg-neon" />Game Hub</span>
          <span className="flex items-center gap-1.5"><span className="w-1 h-1 rounded-full bg-accent-purple" />AI Coach</span>
          <span className="flex items-center gap-1.5"><span className="w-1 h-1 rounded-full bg-accent-blue" />Pro Tips</span>
        </div>
      </div>
    </div>
  );
