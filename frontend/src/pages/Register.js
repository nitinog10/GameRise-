...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-dark bg-hero-gradient bg-grid relative overflow-hidden flex items-center justify-center px-4">
      {/* Decorative orbs */}
      <div className="absolute top-20 right-20 w-72 h-72 bg-neon/10 rounded-full blur-3xl" />
      ...
      <div className="relative z-10 w-full max-w-md animate-scale-in">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-black text-white">Join GameRise</h2>
          <p className="text-gray-500 mt-2 text-sm">Start your esports journey today</p>
        </div>
        ...
        <div className="text-center mt-6">
          <p className="text-gray-500 text-sm">
            ...
            <Link to="/login" className="text-neon font-medium hover:underline">
              Sign In
            </Link>
          </p>
        </div>
